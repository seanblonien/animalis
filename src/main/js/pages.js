...
class AddPetForm extends React.Component {
	...
	onSubmit = pet => {
		pet.userPrincipal = this.props.addPetUser;
...
class DisplayPetsForm extends React.Component {
	...
	handleClick()  {
		this.displayPets();
		this.state.pet_list = res;
		console.log('MY LSIT: ' + res);
	}

	render() {
		return (
			<div>
				{_.isDefined(this.state.pet_list) &&
                	this.state.pet_list.pet_name
				}
				{res}
				...
				<div className="container padded">
					...
					{ _.isDefined(this.props.user) &&
						<div>
							...
							<h2>Add Pets</h2>
							{_.isDefined(this.props.pet) &&
								this.props.pet
							}
							<AddPetForm addPetUser={this.props.user.principal}/>
						</div>
					}
